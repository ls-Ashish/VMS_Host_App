package com.leegosolutions.vms_host_app.activity.notifications;
...
public class N_NotificationsFragment extends Fragment {

    private Context context;
    private FragmentNNortificationsBinding viewBinding;

    public N_NotificationsFragment() {
        // default constructor required, if no default constructor than will crash at orientation change
    }

    public N_NotificationsFragment(Context context) {
        try {
...
//        return inflater.inflate(R.layout.fragment_n_nortifications, container, false);
        try {
            viewBinding = FragmentNNortificationsBinding.inflate(inflater, container, false);
